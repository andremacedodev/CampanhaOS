...
from src.infrastructure.database.repositories.finance_payment_repository import SqlAlchemyFinancePaymentRepository
...
def get_finance_payment_repository(session: DbSession) -> SqlAlchemyFinancePaymentRepository:
    return SqlAlchemyFinancePaymentRepository(session)
...
FinancePaymentRepositoryDep = Annotated[SqlAlchemyFinancePaymentRepository, Depends(get_finance_payment_repository)]
...
def get_get_finance_transaction_use_case(
    ...
    return GetFinanceTransactionUseCase(finance_repository, attachment_repository, payment_repository)
...
def get_update_finance_transaction_use_case(
    ...
    return UpdateFinanceTransactionUseCase(finance_repository, attachment_repository, payment_repository)
...
def get_add_finance_payment_use_case(
    finance_repository: FinanceRepositoryDep,
    payment_repository: FinancePaymentRepositoryDep,
) -> AddFinancePaymentUseCase:
    return AddFinancePaymentUseCase(finance_repository, payment_repository)


def get_list_finance_payments_use_case(
    finance_repository: FinanceRepositoryDep,
    payment_repository: FinancePaymentRepositoryDep,
) -> ListFinancePaymentsUseCase:
    return ListFinancePaymentsUseCase(finance_repository, payment_repository)


def get_remove_finance_payment_use_case(
    payment_repository: FinancePaymentRepositoryDep,
